...
const currentDir = path_1.default.dirname(((_a = require.main) === null || _a === void 0 ? void 0 : _a.filename) || process.cwd());
...
exports.uploadImage = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.uploadImageDirectlyOnCloudinary = (0, asyncHandler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    uploadSingleImage(req, res, (err) => __awaiter(void 0, void 0, void 0, function* () {
        if (err) {
            res.status(400).send({ message: err.message });
        }
        else if (req.file) {
