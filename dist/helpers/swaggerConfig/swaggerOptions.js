...
routes.forEach((routePath) => {
    ...
    const endpoints = (0, express_list_endpoints_1.default)(routesModule);
...
const swaggerOptions = {
    ...
    apis: [], // No need to specify APIs here
};
const swaggerSpec = (0, swagger_jsdoc_1.default)(swaggerOptions);
// Save the generated Swagger documentation to swaggerConfig.yaml
const swaggerFilePath = path_1.default.join(__dirname, "swaggerConfig.yaml");
fs_1.default.writeFile(swaggerFilePath, js_yaml_1.default.dump(swaggerSpec), (err) => {
    if (err) {
